...
namespace AR {
    ...
    public:
        ...
        inline Float calcDsHyperbolic(BinaryTree<Tparticle>& _bin, const Float& _G) {
            ...
            // fprintf(stderr, "G: %e, bin.semi: %e, bin.m1: %e, bin.m2: %e\n", _G, _bin.semi, _bin.m1, _bin.m2); // Eunwoo debug
        ...
        void generateBinaryTree(COMM::ParticleGroup<Tparticle, Tpcm>& _particles, const Float _G) {
            ...
            if (n_particle_real==0) {
                ...
                binarytree[0].Position[0] = _particles[i1].Position[0];
                binarytree[0].Position[1] = _particles[i1].Position[1];
                binarytree[0].Position[2] = _particles[i1].Position[2];
                binarytree[0].Velocity[0] = _particles[i1].Velocity[0];
                binarytree[0].Velocity[1] = _particles[i1].Velocity[1];
                binarytree[0].Velocity[2] = _particles[i1].Velocity[2];
                for (int i=1; i<n_particle_unused; i++) {
                    ...
                    binarytree[i].Position[0] = binarytree[i-1].Position[0];
                    binarytree[i].Position[1] = binarytree[i-1].Position[1];
                    binarytree[i].Position[2] = binarytree[i-1].Position[2];
                    binarytree[i].Velocity[0] = binarytree[i-1].Velocity[0];
                    binarytree[i].Velocity[1] = binarytree[i-1].Velocity[1];
                    binarytree[i].Velocity[2] = binarytree[i-1].Velocity[2];
                }
            }
            else {
                for (int i=0; i<n_particle_unused; i++) {
                    ...
                    binarytree[ilast].Position[0] = binarytree[ilast-1].Position[0];
                    binarytree[ilast].Position[1] = binarytree[ilast-1].Position[1];
                    binarytree[ilast].Position[2] = binarytree[ilast-1].Position[2];
                    binarytree[ilast].Velocity[0] = binarytree[ilast-1].Velocity[0];
                    binarytree[ilast].Velocity[1] = binarytree[ilast-1].Velocity[1];
                    binarytree[ilast].Velocity[2] = binarytree[ilast-1].Velocity[2];
                }
            }
        }
