...
int main (int argv, char **argc) {
	...
	int N = 10000;		     	    //number of stars, Mcl will be set to 0 if specified!
...
//==========================================================
	int N_o = 10000;	// # of ordinary star; for mfunc=3
...
//============================================================
	...
	double fbin = 0.01;				//Primordial binary fraction number of binary systems = 0.5*N*fbin, only used when nbin is set to 0 
